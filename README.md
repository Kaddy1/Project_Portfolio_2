...
### Data Sources
The primary dataset used in this analysis is bank customer churn data from [Kaggle](https://www.kaggle.com/datasets/radheshyamkollipara/bank-customer-churn). The size of the dataset is 10000 and contains information about each customer of a bank such as Age, gender, credit card usage, card type, balance, etc.  
